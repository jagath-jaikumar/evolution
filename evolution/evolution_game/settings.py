"""
Django settings for evolution_game project.
...
SECRET_KEY = "django-insecure-q=^9jpw4y-u7$38@82g01z8-274_1&8e!m$0s0^2#9jyl206c)"
...
WSGI_APPLICATION = "evolution.evolution_game.wsgi.application"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {"level": "DEBUG", "class": "logging.FileHandler", "filename": "evolution.log", "formatter": "verbose"},
    },
    "loggers": {
        "django": {
            "handlers": ["console"],
